         ...
         <div key={id} className='sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw]'>
            <PinContainer title={link} href={link} >
                <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden h-[30vh] sm:h-[40vh] mb-10'>
                    ...
                    <Image src={img} alt={title} className='absolute z-10 bottom-0 w-full h-3/4'/>
                </div>
                ...
                <div className='flex items-center justify-between mt-7 mb-3'>
                 <div className='flex items-center'>
                    ...
                    <div className='flex items-center justify-center'>
                        <Link href={link} className='flex lg:text-xl md:text-xs text-sm text-purple'>Check Live Site</Link>
