    ...
    <div className="pb-20 pt-36">
      ...
      <div className="flex justify-center items-center relative my-20 z-10">
       <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
         ...
         <div className="text-center md:tracking-widest mb-4 text-sm md:text-lg lg:text-2xl">
           <Typewriter
           words={["Hi I'm Salman, a Next.JS Developer", "Hi I'm Salman, a Python Developer","Hi I'm Salman, a FastAPI Developer"]}
           loop={false}
             cursor
             cursorStyle='_'
             typeSpeed={70}
